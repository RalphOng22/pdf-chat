...
class GeminiService:
    ...
    #     try:
    #         # Check if we have table data in our most relevant chunks
    #         table_chunks = [
    ...
    #         if table_chunks:
    #             context_parts = []
    #             for ref in table_chunks:
    #                 try:
    #                     table_data = json.loads(ref['table_data']) if isinstance(ref['table_data'], str) else ref['table_data']
    #                     context_parts.append(
    #                         f"Document: {ref['document_name']} (Page {ref['page_number']})\n"
    #                         f"{table_data.get('html', '')}"
    #                     )
    ...
    #             if context_parts:
    #                 prompt = (
    #                     "Convert the following table into JSON format. "
    #                     "Your response should be ONLY valid JSON, with this structure:\n"
    #                     "{\n"
    #                     '  "title": "title from the table or document",\n'
    #                     '  "source": {"document": "doc name", "page": number},\n'
    #                     '  "periods": ["period1", "period2", ...],\n'
    #                     '  "data": [\n'
    #                     '    {"item": "line item name", "values": [value1, value2, ...]},\n'
    #                     '    ...\n'
    #                     '  ]\n'
    #                     "}\n\n"
    #                     "Table Data:\n"
    ...
    #                 logger.info("Sending JSON conversion prompt to Gemini")
    #                 return await self._generate_response(prompt)

    #         # For non-statement queries, use standard response format
    #         context_parts = []
    ...
    #             "Your task is to convert the provided table data into valid JSON format. "
    #             "Ensure the JSON is well-formed and adheres to the following structure:\n\n"
    #             "{\n"
    #             '  "title": "Title of the table",\n'
    #             '  "source": {"document": "Document name", "page": Page number},\n'
    #             '  "periods": ["Period1", "Period2", ...],\n'
    #             '  "data": [\n'
    #             '    {"item": "Line item name", "values": [Value1, Value2, ...]},\n'
    #             '    ...\n'
    ...
    #             "1. Include the title of the table.\n"
    #             "2. Specify the document name and page number in the 'source' field.\n"
    #             "3. List all periods as column headers under 'periods'.\n"
    #             "4. Include every line item in 'data', with its corresponding values for each period.\n"
    #             "5. Ensure all values are preserved as they appear (e.g., commas, parentheses for negatives).\n"
    #             "6. Do not add any explanatory text outside the JSON object.\n\n"
    #             "Here is the table data from the document:\n"
    #             f"{context_parts}\n\n"
    #             "Provide your response as a valid JSON object in the specified format."
